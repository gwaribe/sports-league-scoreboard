...
- [#1](https://github.com/gwaribe/sports-league-scoreboard/issues/1) - Scaffold the Django backend with a passing test
- [#2](https://github.com/gwaribe/sports-league-scoreboard/issues/2) - Add the Team model and migration
- [#3](https://github.com/gwaribe/sports-league-scoreboard/issues/3) - Implement the Teams endpoints
- [#4](https://github.com/gwaribe/sports-league-scoreboard/issues/4) - Add the Match model and migration
